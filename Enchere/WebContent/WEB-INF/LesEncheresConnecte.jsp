...
<body>
	<nav
		class="d-flex justify-content-around text-dark align-items-center p-3 bg-light">
	<h1>
		<a href="Accueil" class="nav-link">ENI - Enchères</a>
	</h1>
	<a href="Accueil" class="nav-link">Enchères</a> <a
		href="/Enchere/NouvelleVente" class="nav-link">Vendre un article</a> <a
		href="/Enchere/PageAffichageInfosUtilisateur?id=<%=request.getSession().getAttribute("id")%>"
		class="nav-link">Mon profil</a> <a href="ServletDeconnexion"
